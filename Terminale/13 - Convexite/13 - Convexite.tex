...
\DeclareExerciseCollection[topic=cvx01]{cvx01}
\DeclareExerciseCollection[topic=cvx02]{cvx02}
\DeclareExerciseCollection[topic=cvx03]{cvx03}
\DeclareExerciseCollection[topic=cvx04]{cvx04}
...
\begin{exercise}[topic=cvx01]On considère la fonction $f$ dont la courbe représentative est donnée ci-dessous. On a également tracé la tangente à cette courbe au point d'abscisse 0.
