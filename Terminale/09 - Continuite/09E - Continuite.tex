...
\begin{exercise}[subtitle={(Amérique du Nord 2023)}]
...
\begin{center}
\begin{tikzpicture}[scale=0.8]
   \tkzTabInit{$x$ / 1 , $f'(x)$/1, $f$ / 2}{$-\infty$, $1/2$, $3/2$,$+\infty$}
   \tkzTabLine{,+,0, -,0,+,  }
...
\begin{tikzpicture}[scale=1]
   \tkzTabInit{$x$ / 1 ,$g'(x)$/1,$g$/2}{$-\infty$, $-1$, $3$, $+\infty$}
      \tkzTabLine{, +, z, -,z,+,  }
   \tkzTabVar{-/$-\infty$,+/$5.44$,-/$-0.30$,+/$0$}
\end{tikzpicture}
\end{center}
