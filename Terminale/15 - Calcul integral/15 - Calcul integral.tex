...
\DeclareExerciseCollection[topic=int01]{int01}
\DeclareExerciseCollection[topic=int02]{int02}
\DeclareExerciseCollection[topic=int03]{int03}
\DeclareExerciseCollection[topic=int04]{int04}
...
\begin{exercise}[topic=int01]On rappelle que pour tout réel $x$, $|x|= \max(x , -x)$. Déterminer $\displaystyle\int_{-3}^5 |x|\dx$.\end{exercise}
