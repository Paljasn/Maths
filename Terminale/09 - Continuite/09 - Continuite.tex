...
\DeclareExerciseCollection[topic=cont01]{cont01}
\DeclareExerciseCollection[topic=cont02]{cont02}
\DeclareExerciseCollection[topic=cont03]{cont03}
...
\begin{exercise}[topic=cont03]Soit $f$ une fonction continue sur $[0,1]$ telle que, pour tout réel $x \in[0;1]$, on a $f(x) \in[ 0;1]$. Montrer que l'équation $f(x)=x$ admet au moins une solution sur $[0;1]$.\newpage
\end{exercise}
